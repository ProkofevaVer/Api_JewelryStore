...
public partial class DiplomDb3Context : DbContext
{
    public DiplomDb3Context()
    {
    }

    public DiplomDb3Context(DbContextOptions<DiplomDb3Context> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-94UBSDB\\SQLEXPRESS;Database=DiplomDB_3;Trusted_Connection=True;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<CardItem>(entity =>
        {
            ...
            entity.Property(e => e.CardQuantity).HasColumnName("card_quantity");
            entity.Property(e => e.CardTotalPrice)
                .HasColumnType("decimal(18, 0)")
                .HasColumnName("card_total_price");
            entity.Property(e => e.JewelrySizesItemId).HasColumnName("JewelrySizesItem_id");
            entity.Property(e => e.Status).HasColumnName("status");
            entity.Property(e => e.UserId).HasColumnName("user_id");

            entity.HasOne(d => d.JewelrySizesItem).WithMany(p => p.CardItems)
                .HasForeignKey(d => d.JewelrySizesItemId)
                .HasConstraintName("FK_CardItems_JewelrySizes");

            entity.HasOne(d => d.User).WithMany(p => p.CardItems)
                .HasForeignKey(d => d.UserId)
                .HasConstraintName("FK_CardItems_User");
        });
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__JewelryS__3213E83F01656C6D");
            ...
            entity.HasOne(d => d.JewelryItem).WithMany(p => p.JewelrySizes)
                .HasForeignKey(d => d.JewelryItemId)
                .HasConstraintName("FK__JewelrySi__jewel__60A75C0F");
        });
        ...
        modelBuilder.Entity<Purchase>(entity =>
        {
            ...
            entity.Property(e => e.Id)
                .ValueGeneratedOnAdd()
                .HasColumnName("id");
            entity.Property(e => e.JewelryItemsSizeId).HasColumnName("jewelryItemsSize_id");
            ...
            entity.HasOne(d => d.JewelryItemsSize).WithMany()
                .HasForeignKey(d => d.JewelryItemsSizeId)
                .HasConstraintName("FK_Purchase_JewelrySizes");
